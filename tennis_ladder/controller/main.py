...
button_frame = tk.Frame(main_window, bg='white', bd=2)  # Frame for buttons
button_frame.pack(side="left", fill="y", pady='90')  # Places the frame vertically on the left side
...
#Add the Restart Button to the button frame and restart the Tournament.
restart_button = create_restart_button(button_frame)
restart_button.pack(padx=10, pady=10)

#Add the Ranking Button to the button frame and get the ordered ranking.
